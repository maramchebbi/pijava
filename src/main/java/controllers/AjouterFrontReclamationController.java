...
public class AjouterFrontReclamationController implements Initializable {
    ...
    private void setupDragAndDrop() {
        ...
        dropZone.setOnDragOver(event -> {
            if (event.getGestureSource() != dropZone && event.getDragboard().hasFiles()) {
                ...
                // Changement visuel pour indiquer que la zone accepte le dépôt (couleurs beige)
                dropZone.setStyle("-fx-border-color: #8B4513; -fx-border-style: dashed; -fx-border-radius: 4; " +
                        "-fx-border-width: 2; -fx-background-color: #F5F5DC; -fx-padding: 15;");
            }
            event.consume();
        });
        ...
        dropZone.setOnDragExited(event -> {
            ...
            dropZone.setStyle("-fx-border-color: #D2B48C; -fx-border-style: dashed; -fx-border-radius: 4; " +
                    "-fx-border-width: 2; -fx-background-color: #F5F0E1; -fx-padding: 15;");
            event.consume();
        });
    ...
    private void handleAjouterReclamation(ActionEvent event) {
        ...
        try {
            ...
            // Redirection vers Home.fxml et affichage des réclamations
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/Home.fxml"));
                Parent root = loader.load();

                // Récupérer le contrôleur de Home pour pouvoir charger les réclamations
                ...
                // IMPORTANT: Charger le contenu des réclamations dans la zone de contenu de Home
                homeController.loadReclamationsContent();
